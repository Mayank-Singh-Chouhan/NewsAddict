      ...
      <>
        <Router>
          <div>
            ...
            <Routes>
              <Route path="/" exact element={<News key="sports" pageSize={this.pageSize} country="in" category="sports" />} />
              ...
              <Route path="/science" exact element={<News key="science" pageSize={this.pageSize} country="in" category="science" />} />
